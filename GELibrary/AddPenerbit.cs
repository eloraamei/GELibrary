...
namespace GELibrary
{
    public partial class AddPenerbit : Form
    {
        public AddPenerbit()
        {
            InitializeComponent();
            string query = "SELECT TOP 1 ID FROM Penerbit_Buku ORDER BY ID DESC";
            txtID.Text = autogenerateID("PB", query);
            txtID.Enabled = false;
            txtNama.Select();
        }
        ...
        private void btnTambah_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    com.CommandText = "sp_InputPenerbitBuku";
